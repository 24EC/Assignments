...
export class HomePageSteps {
    ...
    //Method to verify: Application Hub link is displayed on the home page. 
    async verifyApplicationHubLinkDisplayed() {
        await this.web.isElementVisible(homePage.applicationHubLink);
    }
